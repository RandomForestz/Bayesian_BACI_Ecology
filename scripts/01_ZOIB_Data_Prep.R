...
# 01 Zero One Inflated Beta Data Prep
...
#==============================================================================#
# Adding in treatment information Found in PRIPP Species Database / Tern/Plover / Annual Site Data
library(tibble)
...
site_mgmt <- tribble(
  ...
  # Cottonwood Ranch
  #-----------------------------#
  "Cottonwood Ranch", 2010, 0, 0, 0, 0,
  "Cottonwood Ranch", 2011, 0, 1, 0, 0,
  "Cottonwood Ranch", 2012, 0, 1, 0, 0,
  "Cottonwood Ranch", 2013, 0, 1, 0, 0,
  "Cottonwood Ranch", 2014, 0, 1, 0, 0,
  "Cottonwood Ranch", 2015, 0, 1, 0, 0,
  "Cottonwood Ranch", 2016, 0, 1, 0, 0,
  "Cottonwood Ranch", 2017, 0, 1, 0, 0,
  "Cottonwood Ranch", 2018, 0, 1, 0, 0,
  "Cottonwood Ranch", 2019, 0, 1, 0, 0,
  ...
  #-----------------------------#
  "Kearney Broadfoot South", 2010, 0, 0, 0, 0,
  "Kearney Broadfoot South", 2011, 0, 1, 0, 0,
  "Kearney Broadfoot South", 2012, 0, 1, 0, 0,
  "Kearney Broadfoot South", 2013, 0, 1, 0, 0,
  "Kearney Broadfoot South", 2014, 0, 1, 0, 0,
  "Kearney Broadfoot South", 2015, 0, 1, 0, 0,
  "Kearney Broadfoot South", 2016, 0, 1, 0, 0,
  "Kearney Broadfoot South", 2017, 0, 1, 0, 0,
  "Kearney Broadfoot South", 2018, 0, 1, 0, 0,
  "Kearney Broadfoot South", 2019, 0, 1, 0, 0,
  ...
  # OSG Lexington
  #-----------------------------#
  "OSG Lexington", 2010, 0, 0, 0, 0,
  "OSG Lexington", 2011, 0, 0, 0, 0,
  "OSG Lexington", 2012, 0, 0, 0, 0,
  "OSG Lexington", 2013, 0, 0, 0, 0,
  "OSG Lexington", 2014, 0, 0, 0, 0,
  "OSG Lexington", 2015, 0, 0, 0, 0,
  "OSG Lexington", 2016, 0, 0, 0, 0,
  "OSG Lexington", 2017, 0, 0, 0, 0,
  "OSG Lexington", 2018, 0, 0, 0, 0,
  "OSG Lexington", 2019, 0, 0, 0, 0,
  ...
  # Newark East
  #-----------------------------#
  "Newark East", 2010, 0, 0, 0, 0,
  "Newark East", 2011, 0, 0, 0, 0,
  "Newark East", 2012, 0, 0, 0, 0,
  "Newark East", 2013, 0, 0, 0, 0,
  "Newark East", 2014, 0, 1, 0, 0,
  "Newark East", 2015, 0, 1, 0, 0,
  "Newark East", 2016, 0, 1, 0, 0,
  "Newark East", 2017, 0, 1, 0, 0,
  "Newark East", 2018, 0, 1, 0, 0,
  "Newark East", 2019, 0, 1, 0, 0,
  ...
  # Newark West
  #-----------------------------#
  "Newark West", 2010, 0, 0, 0, 0,
  "Newark West", 2011, 0, 1, 0, 0,
  "Newark West", 2012, 0, 1, 0, 0,
  "Newark West", 2013, 0, 1, 0, 0,
  "Newark West", 2014, 0, 1, 0, 0,
  "Newark West", 2015, 0, 1, 0, 0,
  "Newark West", 2016, 0, 1, 0, 0,
  "Newark West", 2017, 0, 1, 0, 0,
  "Newark West", 2018, 0, 1, 0, 0,
  "Newark West", 2019, 0, 1, 0, 0,
  "Newark West", 2020, 1, 1, 0, 1,
  "Newark West", 2021, 1, 1, 0, 1,
  "Newark West", 2022, 1, 1, 0, 1,
  "Newark West", 2023, 1, 1, 0, 1,
  "Newark West", 2024, 1, 1, 0, 1,
  "Newark West", 2025, 1, 1, 0, 1,
  
  #-----------------------------#
  # NPPD Lexington
  #-----------------------------#
  "NPPD Lexington", 2010, 0, 0, 0, 0,
  "NPPD Lexington", 2011, 0, 1, 0, 0,
  "NPPD Lexington", 2012, 0, 1, 0, 0,
  "NPPD Lexington", 2013, 0, 1, 0, 0,
  "NPPD Lexington", 2014, 0, 1, 0, 0,
  "NPPD Lexington", 2015, 0, 1, 0, 0,
  "NPPD Lexington", 2016, 0, 1, 0, 0,
  "NPPD Lexington", 2017, 0, 1, 0, 0,
  "NPPD Lexington", 2018, 0, 1, 0, 0,
  "NPPD Lexington", 2019, 0, 1, 0, 0,
  ...
  # Follmer
  #-----------------------------#
  "Follmer", 2010, 0, 0, 0, 0,
  "Follmer", 2011, 0, 0, 0, 0,
  "Follmer", 2012, 0, 0, 0, 0,
  "Follmer", 2013, 0, 0, 0, 0,
  "Follmer", 2014, 0, 0, 0, 0,
  "Follmer", 2015, 0, 1, 0, 0,
  "Follmer", 2016, 0, 1, 0, 0,
  "Follmer", 2017, 0, 1, 0, 0,
  "Follmer", 2018, 0, 1, 0, 0,
  "Follmer", 2019, 0, 0, 0, 0,
  ...
  # Blue Hole
  #-----------------------------#
  "Blue Hole", 2010, 0, 0, 0, 0,
  "Blue Hole", 2011, 0, 1, 0, 0,
  "Blue Hole", 2012, 0, 1, 0, 0,
  "Blue Hole", 2013, 0, 1, 0, 0,
  "Blue Hole", 2014, 0, 1, 0, 0,
  "Blue Hole", 2015, 0, 1, 0, 0,
  "Blue Hole", 2016, 0, 1, 0, 0,
  "Blue Hole", 2017, 0, 1, 0, 0,
  "Blue Hole", 2018, 0, 1, 0, 0,
  "Blue Hole", 2019, 0, 1, 0, 0,
